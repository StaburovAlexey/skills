...
- [Geometry](geometry.md) — Geometry creation and manipulation
- [Materials](materials.md) — Material types and properties
- [Lighting](lighting.md) — Light types and shadows
